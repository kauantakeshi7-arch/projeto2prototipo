  ...
  public static buildSetup(intent: Intent): PCPartDefinition[] {
    ...
    if (b < 5500) {
      return [
        ...
        { componentName: "Memória RAM", searchQuery: "Memoria Kingston 16GB DDR4", minPrice: 200, maxPrice: 350, reason: "16GB é a zona de conforto para rodar jogos AAA e ter o Discord/Navegador aberto sem travamentos." },
    ...
    if (b < 8000) {
      return [
        ...
        { componentName: "Memória RAM", searchQuery: "Memoria Kingston 32GB DDR5", minPrice: 600, maxPrice: 900, reason: "O dobro de velocidade de um PC padrão. 32GB te preparam para o futuro dos games em mundo aberto e simuladores." },
    ...
    return [
      ...
      { componentName: "Memória RAM", searchQuery: "Memoria Kingston 64GB DDR5", minPrice: 1200, maxPrice: 1800, reason: "64GB elimina qualquer lentidão concebível, perfeito para editar vídeos pesados, streamar e jogar simultaneamente." },
