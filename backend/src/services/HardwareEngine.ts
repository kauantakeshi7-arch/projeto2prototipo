  ...
  public static buildSetup(intent: Intent): PCPartDefinition[] {
    ...
    if (b < 2500 || intent.category === 'office') {
      return [
        ...
        { componentName: "Memória RAM", searchQuery: "Memoria RAM 16GB DDR4 3200MHz desktop", minPrice: 150, maxPrice: 250, reason: "16GB é o mínimo absoluto hoje em dia, e a alta frequência (3200MHz) faz a placa de vídeo integrada do Ryzen render muito mais." },
    ...
    if (b < 5500) {
      return [
        ...
        { componentName: "Memória RAM", searchQuery: "Memoria RAM 16GB DDR4 3200MHz desktop", minPrice: 200, maxPrice: 350, reason: "16GB é a zona de conforto para rodar jogos AAA e ter o Discord/Navegador aberto sem travamentos." },
    ...
    if (b < 8000) {
      return [
        ...
        { componentName: "Memória RAM", searchQuery: "Memoria RAM 32GB DDR5 5200MHz desktop", minPrice: 600, maxPrice: 900, reason: "O dobro de velocidade de um PC padrão. 32GB te preparam para o futuro dos games em mundo aberto e simuladores." },
    ...
    return [
      ...
      { componentName: "Memória RAM", searchQuery: "Memoria RAM 64GB DDR5 6000MHz desktop", minPrice: 1200, maxPrice: 1800, reason: "64GB a 6000MHz elimina qualquer lentidão concebível, perfeito para editar vídeos pesados, streamar e jogar simultaneamente." },
